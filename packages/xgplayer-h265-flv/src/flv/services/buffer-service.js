...
export class BufferService {
  ...
  init(type) {
    if (type == 'avc') {
      ...
      this._mse = new MSE(null, {
        preferMMS:
          typeof this._opts.preferMMS === 'boolean'
            ? this._opts.preferMMS
            : !!this._opts.perferMMS /* perferMMS is typo, deprecated */
      })
      this._mse.bindMedia(this.flv.media)
    } else {
    }
  }
  ...
  async appendBuffer(chunk) {
    ...
    if (mse) {
      ...
      // console.log('this._needInitSegment',this._needInitSegment)
      ...
      try {
        ...
        //   audioTrack.duration =
        //     this._opts.durationForMSELowLatencyOff * audioExist.timescale
        // }
